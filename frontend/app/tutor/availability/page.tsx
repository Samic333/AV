    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-navy-600">Set your available time slots for lessons</p>
        </div>

        <Card>
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-navy-900 mb-4">Weekly Schedule</h2>
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="w-5 h-5 text-sky-blue-600 rounded"
                    />
                    <label className="flex-1 font-medium text-navy-900 min-w-[120px]">
                      {day}
                    </label>
                    {slot.isActive && (
