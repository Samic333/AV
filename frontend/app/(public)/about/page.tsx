    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About AviatorTutor</h1>
        ...
        <div className="space-y-12">
          ...
          <Card>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Verified Instructors</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Comprehensive Subjects</h3>
                <p className="text-gray-700">
          ...
          <Card>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Who Can Use AviatorTutor?</h2>
