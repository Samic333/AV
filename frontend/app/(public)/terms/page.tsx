    ...
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="prose max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-navy-900 mb-4">4. Tutor Responsibilities</h2>
            <p className="text-navy-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-navy-900 mb-4">5. Student Responsibilities</h2>
            <p className="text-navy-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-navy-900 mb-4">6. Payments and Refunds</h2>
            <p className="text-navy-700 mb-4">
          ...
          <section className="mt-8 pt-8 border-t border-gray-200">
            <p className="text-navy-700 text-sm">
              ...
              <a href="mailto:legal@aviatortutor.com" className="text-sky-blue-600 hover:underline ml-1">
