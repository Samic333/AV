    ...
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-navy-700">Last updated: {new Date().toLocaleDateString()}</p>
        </div>
        ...
        <Card className="prose max-w-none">
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-navy-700 space-y-2">
              ...
              <li>Profile information (bio, qualifications, experience)</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-navy-700 mb-4">We use the information we collect to:</p>
            <ul className="list-disc pl-6 text-navy-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-navy-700 space-y-2">
              <li>With tutors/students as necessary to facilitate bookings</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-navy-700 mb-4">You have the right to:</p>
            <ul className="list-disc pl-6 text-navy-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-navy-700 mb-4">
              ...
              hold certain information. See our Cookie Policy for more details.
            </p>
          </section>
          ...
          <section className="mt-8 pt-8 border-t border-gray-200">
            <p className="text-navy-700 text-sm">
              ...
              <a href="mailto:privacy@aviatortutor.com" className="text-sky-blue-600 hover:underline ml-1">
