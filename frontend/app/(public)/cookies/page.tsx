    ...
    <div className="min-h-screen bg-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-navy-900 mb-4">Cookie Policy</h1>
        ...
        <Card className="prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-navy-700 mb-4">We use cookies for the following purposes:</p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-navy-900 mb-4">Managing Cookies</h2>
            <p className="text-navy-700 mb-4">
            ...
            <p className="text-navy-700 mb-4">Most browsers allow you to:</p>
            <ul className="list-disc pl-6 text-navy-700 space-y-2">
