    ...
    <div className="min-h-screen bg-sky-blue-50">
      <div className="max-w-7xl mx-auto p-8">
        <div className="mb-8">
          ...
          <p className="text-navy-600">Chat with your instructors</p>
        </div>
              ...
              {loading ? (
                ...
                <div className="flex-1 flex items-center justify-center text-center">
                  <div>
                    ...
                    <Link href="/tutors">
                      <Button variant="outline" size="sm">Find Instructor</Button>
                    </Link>
                  </div>
                </div>
              ) : (
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          ...
                          {unreadCount > 0 && (
                            <Badge variant="info" className="bg-sky-blue-600 text-white">
                              {unreadCount}
                            </Badge>
                          )}
                        </div>
